...
public class Main {
	...
	public static void main(String[] args) {
        ...
        //cette methode gere la premi�re partie du jeu: Ench�re pour les plantes
        ...
        public void enchereParcelleClient() {
            ...
            for (int i = 0; i < joueurs.size(); i++) {
                ...
                //si quelqu'un d'autre à jouer r�cup�re son choix
                else {
        ...
        //g�re la deuxieme phase du jeu le changement du constructeur
