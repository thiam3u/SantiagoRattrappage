...
public class Server {
    ...
    public void startServer() {
        ...
        System.out.println("Le serveur est démarré et attend des connéxions.");
        System.out.println("avec les multi-threds les connexion multiples sont autorisé.");
        System.out.println("tout client peux envoyéer -1 pour arréter le serveur .");
...
class Server2Connection implements Runnable {
    ...
    public Server2Connection(Socket clientSocket, int id, Server server) {
        ...
        this.id = id;
        this.server = server;
        System.out.println( "Connection " + id + " établis avec : " + clientSocket );
        try {
    ...
    public void run() {
        int n;
        System.out.println("client thread créer");
        try {
